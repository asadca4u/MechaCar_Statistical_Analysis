...
#Deliverable 3
#Lot 1
t.test(SuspensionDF$PSI, mu=1500, subset(SuspensionDF, Manufacturing_Lot == "Lot1", select=PSI))
#Lot 2
t.test(SuspensionDF$PSI, mu=1500, subset(SuspensionDF, Manufacturing_Lot == "Lot2", select=PSI))
#Lot 3
t.test(SuspensionDF$PSI, mu=1500, subset(SuspensionDF, Manufacturing_Lot == "Lot3", select=PSI))
